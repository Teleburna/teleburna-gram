...
import org.cafemember.SQLite.SQLiteCursor;
...
import org.cafemember.ui.ProfileActivity;
        ...
        Utilities.stageQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public void run() {
//                        Commands.checkChannels(dialogs);
                        if (!isCache) {
    ...
    public void markDialogAsRead(final long dialog_id, final int max_id, final int max_positive_id, final int max_date, final boolean was, final boolean popup) {
        ...
        if (lower_part != 0) {
            ...
            if (inputPeer instanceof TLRPC.TL_inputPeerChannel) {
                ...
                /*if(Defaults.getInstance().getMyChannelId() == -lower_part && was){
                    Commands.view(max_positive_id);
                }*/
            } else {
