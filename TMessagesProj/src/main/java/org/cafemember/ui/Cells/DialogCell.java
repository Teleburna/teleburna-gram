...
public class DialogCell extends BaseCell {
    ...
    private static Drawable addChannelDrawable;

    private int addChannelLeft = AndroidUtilities.dp(10);
    private int addChannelTop = AndroidUtilities.dp(5);
    private int addChannelWith = AndroidUtilities.dp(40);
    private boolean drawAddChannel = false;
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            addChannelDrawable = getResources().getDrawable(R.drawable.ic_telegram_join);
        }
    ...
    public void buildLayout() {
        addChannelLeft = getMeasuredWidth() - addChannelWith;
        String nameString = "";
        String timeString = "";
        ...
        if (isDialogCell) {
            ...
            if(dialog instanceof TLRPC.TL_dialogChannel && dialog.id != -Defaults.getInstance().getMyChannelId()){
                drawAddChannel = true;
            }
            else {
                drawAddChannel = false;
            }
        }
        ...
        if (!LocaleController.isRTL) {
            timeLeft = getMeasuredWidth() - AndroidUtilities.dp(15) - timeWidth - addChannelWith;
        } else {
            timeLeft = AndroidUtilities.dp(15) + addChannelWith;
        }
        ...
        if (!LocaleController.isRTL) {
            nameWidth = getMeasuredWidth() - nameLeft - AndroidUtilities.dp(14) - timeWidth - addChannelWith;
        } else {
            nameWidth = getMeasuredWidth() - nameLeft - AndroidUtilities.dp(AndroidUtilities.leftBaseline) - timeWidth - addChannelWith;
            nameLeft += timeWidth + addChannelWith;
        }
        if (drawNameLock) {
        ...
        if (drawClock) {
            ...
            nameWidth -= w;
            if (!LocaleController.isRTL) {
                checkDrawLeft = timeLeft - w - addChannelWith;
            } else {
                checkDrawLeft = timeLeft + timeWidth + AndroidUtilities.dp(5) + addChannelWith;
                nameLeft += w;
            }
        } else if (drawCheck2) {
            ...
            if (drawCheck1) {
                ...
                if (!LocaleController.isRTL) {
                    ...
                    checkDrawLeft = halfCheckDrawLeft - AndroidUtilities.dp(5.5f) - addChannelWith;
                } else {
                    checkDrawLeft = timeLeft + timeWidth + AndroidUtilities.dp(5) + addChannelWith;
        ...
        int messageWidth = getMeasuredWidth() - AndroidUtilities.dp(AndroidUtilities.leftBaseline + 16) - addChannelWith;
        int avatarLeft;
        if (!LocaleController.isRTL) {
        ...
        if (drawError) {
            ...
            messageWidth -= w;
            if (!LocaleController.isRTL) {
                errorLeft = getMeasuredWidth() - errorDrawable.getIntrinsicWidth() - AndroidUtilities.dp(11) - addChannelWith;
            } else {
                errorLeft = AndroidUtilities.dp(11) + addChannelWith;
                messageLeft += w;
            }
            ...
            messageWidth -= w;
            if (!LocaleController.isRTL) {
                countLeft = getMeasuredWidth() - countWidth - AndroidUtilities.dp(19) - addChannelWith;
            } else {
                countLeft = AndroidUtilities.dp(19) + addChannelWith;
                messageLeft += w;
            }
            drawCount = true;
        } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawAddChannel) {
            setDrawableBounds(addChannelDrawable, addChannelLeft, addChannelTop);
            addChannelDrawable.draw(canvas);
        }
