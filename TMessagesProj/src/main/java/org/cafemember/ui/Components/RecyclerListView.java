...
public class RecyclerListView extends RecyclerView {
    ...
    private OnItemClickListener onAddChannelClickListener;
        ...
        public RecyclerListViewItemClickListener(Context context) {
            mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onSingleTapUp(MotionEvent e) {
                    if (currentChildView != null && onAddChannelClickListener != null) {
                        float x = e.getX();
//                        float y = e.getY()%((currentChildPosition+1)*currentChildView.getHeight());
                        RecyclerView.Adapter adapter = getAdapter();
                        if(adapter instanceof DialogsAdapter){
                            TLRPC.Dialog dialog = ((DialogsAdapter) adapter).getItem(currentChildPosition);
                            if(dialog instanceof TLRPC.TL_dialogChannel){
                                if(x > currentChildView.getWidth() - AndroidUtilities.dp(40)){
                                    onAddChannelClickListener.onItemClick(currentChildView, currentChildPosition);
                                    return true;
                                }
                            }
                        }
    ...
    public void setOnAddChannelClickListener(OnItemClickListener listener) {
